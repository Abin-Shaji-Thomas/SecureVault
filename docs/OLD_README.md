# 🔐 SecureVault Pro - Enhanced Password Manager# 🔐 SecureVault Pro - Enhanced Password Manager



**Version 3.0** - A beautiful, feature-rich password management application with military-grade security, Samsung-inspired UI, and advanced password management features.**Version 3.0** - A beautiful, feature-rich password management application with military-grade security, Samsung-inspired UI, and advanced password management features.
...
![Java](https://img.shields.io/badge/java-25-orange)![Java](https://img.shields.io/badge/java-25-orange)

![License](https://img.shields.io/badge/license-personal%20use-blue)![License](https://img.shields.io/badge/license-personal%20use-blue)
...
# Make executable (first time only)# Make executable (first time only)

chmod +x run.shchmod +x run.sh



# Launch SecureVault Pro# Launch SecureVault Pro
...
- ✅ **Secure Clipboard** - Auto-clear copied passwords after 30 seconds- Store website URLs with credentials

- ✅ **Manual Lock** - Instant vault locking (Ctrl+L)

- ✅ **Password Strength Analysis** - Real-time strength checking with visual indicators- "🌐 Open" button launches browser directly### 🎨 Theme Support- **Manual Lock Button** - Instant vault locking ✅



### 💎 Password Management- Auto-prepends https:// if missing

- ⭐ **Favorites System** - Mark important credentials with golden stars

- 🔍 **Real-Time Search** - Instant filtering as you type (Ctrl+F)- Perfect for quick access to login pages- **Light Mode** - Clean purple theme with white backgrounds

- 🎯 **Smart Filters** - View all, favorites only, or filter by password strength (Weak/Medium/Strong)

- 📊 **6 Sort Options** - Sort by title, username, created date, modified date, or favorites

- 📝 **Notes Field** - Add detailed notes to each credential

- 👤 **Copy Username/Password** - Quick copying with separate buttons#### 📅 **Password Expiry Management**- **Dark Mode** - Comfortable blue theme with dark backgrounds- **SHA-256 Authentication** - Salted password hashing ✅

- 📅 **Timestamps** - Track when credentials were created and last modified

- Set expiry dates for passwords

### 🆕 Advanced Features (v3.0)

- Default 90-day expiry for new credentials- **Gradient Headers** - Smooth purple-to-blue gradient banner

#### 📂 Categories System

- 7 default categories: Social Media, Banking, Email, Work, Shopping, Entertainment, Other- Visual warnings in table:

- Custom category support (add your own categories)

- Color-coded category badges in table view  - ⛔ **EXPIRED** (red) - Password has expired- **Hover Effects** - Interactive button highlighting
...
- Website URL field for each credential  - Date (green) - Valid expiry date- **Color-Coded Strength** - Visual password strength indicators

- Quick "Open in Browser" button (🌐) to launch URLs directly

- Automatic URL validation- "📅 +90 Days" button for quick expiry setting



#### ⏰ Password Expiry Tracking### 💼 **Features**### 🔐 Security Features## FeaturesA modular, database-backed password manager with Swing GUI.Welcome to the VS Code Java world. Here is a guideline to help you get started to write Java code in Visual Studio Code.

- Set expiry dates for credentials

- Visual expiry warnings:#### 📊 **Security Health Dashboard**
...
- Quick "+90 Days" button to set expiry date- Password strength distribution (Strong/Medium/Weak)

- Automatic expiry notifications in Health Dashboard

- **Reused passwords** detection- Multi-user support with isolated vaults

#### 📥 Import/Export Manager

- **Import from:**- **Expired passwords** count
  ...
  - Duplicate detection and prevention- Credentials needing attention list
...
- **Export to:**
  ...
  - Organized and sorted structure

  - Secure password-protected archives#### 📤 **Import/Export**- Linux/macOS/Windows



#### 📎 Encrypted Attachments- **Import from:**

- Upload files up to **10 MB** per credential

- Encrypted storage in database as BLOBs  - Google Chrome CSV export- Password strength meter & analyzer

- Download/view attachments anytime

- Delete individual attachments  - Mozilla Firefox CSV export
...
#### 📊 Health Dashboard  - Opera CSV export

- **Security Score** (0-100) calculated from:

  - Password strength distribution  - Generic CSV files- Secure password generator- **SHA-256 Hashing**: All user passwords are hashed with unique 16-byte salts
...
- **Visual Statistics:**
  ...
  - Expired/Expiring soon alerts  - Encrypted ZIP archive with:
...
- **Action Items:**
  ...
  - Direct links to update weak/expired passwords
...
- Visual expiry warnings (red/amber/green)- Duplicate prevention during import- One-click copy to clipboard- **Password Masking**: Credentials displayed with asterisks (••••••)
...
- **➕ Add** - Create new credential (Ctrl+N)
...
- **⭐ Favorite** - Toggle favorite status- Delete individual attachments```

- **🎲 Generate** - Random password generator

- **🔍 Strength** - Check password strength- Attachment count tracking

- **📥 Import** - Import credentials from CSV/ZIP

- **📤 Export** - Export to encrypted archive- Perfect for recovery codes, IDs, documents- **Secure Password Generation**: Cryptographically secure random password generator### 🔐 Multi-User System

- **📊 Health** - View security dashboard

- **🔒 Lock** - Lock vault (Ctrl+L)

- **🎨 Theme** - Toggle dark/light mode

- **🚪 Logout** - Logout and exit## 🎨 User Interface### Default Login
